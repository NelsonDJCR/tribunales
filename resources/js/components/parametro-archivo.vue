        ...
        <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Tipo de archivo
    ...
    export default {
        ...
        methods : {
            listarDepartamento (page,buscar,criterio){
                var url= this.ruta + '/tipo-archivo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            actualizarDepartamento(){
               if (this.validarDepartamento()){
                ...
                axios.post(this.ruta + `/actualizar-parametro/${this.departamento_id}/tipo_archivo/${this.nombre}`,{
                    'nombre': this.nombre,
                }).then((response) => {
                    this.cerrarModal();
                    this.listarDepartamento(1,'','nombre');
            ...
            desactivarDepartamento(id){
               swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post(this.ruta + `/inactivar-estado/${id}/tipo_archivo/0`,{
                        'id': id
                    }).then((response) => {
                        this.listarDepartamento(1,'','nombre');
                        swal.fire(
            ...
            activarDepartamento(id){
               swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post(this.ruta + `/inactivar-estado/${id}/tipo_archivo/1`,{
                        'id': id
                    }).then((response) => {
                        this.listarDepartamento(1,'','nombre');
                        swal.fire(
                ...
                switch(modelo){
                    case "departamento":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar Tipo Archivo';
                                this.nombre= '';
                                this.tipoAccion = 1;
                                break;
                            }
                            case 'actualizar':
                            {
                                //console.log(data);
                                this.modal=1;
                                this.tituloModal='Actualizar Tipo Archivo';
                                this.tipoAccion=2;
