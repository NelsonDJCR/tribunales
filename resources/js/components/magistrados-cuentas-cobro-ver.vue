<template>
  <div class="main col-12" id="sesion">
    ...
    <div class="container mt-5">
      <!-- Breadcrumb -->
      <ol class="breadcrumb">
          <li class="breadcrumb-item active"><router-link :to="{ name: 'home'}"><span>Home</span></router-link> / <label for="" class="p-2">Funcionarios / Listado de cuentas de cobro / Ver cuenta de cobro </label></li>
      </ol>
