<template>
  <div class="main col-12" id="sesion">
    ...
    <div class="container mt-5">
      <!-- Breadcrumb -->
        <ol class="breadcrumb">
            <li class="breadcrumb-item active"><router-link :to="{ name: 'home'}"><span>Home</span></router-link> / <label for="" class="p-2">Tribunales de Garantía / Listado de Magistrados / Editar Magistrado</label></li>
        </ol>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-5">
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
              <button type="submit"  class="btn btn-secondary active">Guardar Magistrado</button>
