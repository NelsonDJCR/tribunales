        ...
        <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Tipo de trámite
    ...
    export default {
        ...
        methods : {
            listarDepartamento (page,buscar,criterio){
                var url= this.ruta + '/tipo-tramite?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            ...
            actualizarDepartamento(){
               if (this.validarDepartamento()){
                ...
                axios.post(this.ruta + `/actualizar-parametro/${this.departamento_id}/tipo_tramite/${this.nombre}`,{
                    'nombre': this.nombre,
                }).then((response) => {
                    this.cerrarModal();
                    this.listarDepartamento(1,'','nombre');
            ...
            desactivarDepartamento(id){
               swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post(this.ruta + `/inactivar-estado/${id}/tipo_tramite/0`,{
                        'id': id
                    }).then((response) => {
                        this.listarDepartamento(1,'','nombre');
                        swal.fire(
            ...
            activarDepartamento(id){
               swal.fire({
                ...
                if (result.value) {
                    ...
                    axios.post(this.ruta + `/inactivar-estado/${id}/tipo_tramite/1`,{
                        'id': id
                    }).then((response) => {
                        this.listarDepartamento(1,'','nombre');
                        swal.fire(
                ...
                switch(modelo){
                    case "departamento":
                    {
                        switch(accion){
                            ...
                            {
                                this.modal = 1;
                                this.tituloModal = 'Registrar Tipo de trámite';
                                this.nombre= '';
                                this.tipoAccion = 1;
                                break;
                            }
                            case 'actualizar':
                            {
                                //console.log(data);
                                this.modal=1;
                                this.tituloModal='Actualizar Tipo de trámite';
                                this.tipoAccion=2;
