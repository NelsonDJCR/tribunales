    ...
    <div class="container mt-5">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item active">
          ...
          <label for="" class="p-2"
            >Funcionarios / Mis actividades / Ver actividad
          </label>
        </li>
      </ol>
                      ...
                      >
                        <div class="btn btn-light btn-sm mt-2">
                          <span class="text-start float-start">
                            ...
                            >
                              <option
                                v-for="(item, index) in tipo_archivo"
                                :key="index"
                                :value="item.id"
                                v-text="item.nombre"
                              ></option>
                          ...
                          <span class="badge bg-info float-end text-end m-1">
                            <a class="" :href="i.ruta" :download="i.ruta"
                              ><i class="fa fa-download fa-md"></i></a
                          ></span>
                          <a class="text-end">
